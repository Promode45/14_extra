...
final_spec <- xgboost(
  data = x,
  label = y,
  nrounds = best_rmse$trees,
  max_depth = best_r2$tree_depth,
  min_child_weight= best_r2$min_n,
  gamma = best_r2$loss_reduction,
  subsample = best_r2$sample_size,
  colsample_bytree = best_r2$mtry,
  eta = best_r2$learn_rate,
  alpha = 0.2,
